...
public class SonarQubeUtil {
	...
	static {
		try {
			Configuration configuration = new Configurations().properties(new File("/", "sonarqube.properties"));
	...
	public static Map<String, Object> measuresComponent(String componentKey) {
		...
		List<Map<String, Object>> list = (List<Map<String, Object>>) (((Map<String, Object>) (JsonUtil
				.parse(result, Map.class).get("component"))).get("measures"));
